let data; // Déclare une variable globale pour stocker les données des recettes
...
fetch("/happyMeal/public/data.json")
    ...
    .then(jsonData => {
        data = jsonData; // Stocke les données dans la variable globale
        console.log("Données chargées :", data);

        // Appels de fonctions pour afficher les recettes et la pagination
