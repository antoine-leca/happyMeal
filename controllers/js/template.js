...
const footer = `
    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-white dark:text-white font-medium">
                      <li class="mb-4">
                          <a href="https://flowbite.com/" class="hover:underline">Recettes</a>
                      </li>
                      <li>
              ...
              <div>
                  ...
                  <ul class="text-white dark:text-white font-medium">
                      <li class="mb-4">
                          <a href="https://github.com/themesberg/flowbite" class="hover:underline ">Panier</a>
                      </li>
                      <li>
                          <a href="https://discord.gg/4eeurUVvTy" class="hover:underline">Favoris</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul class="text-white dark:text-white font-medium">
                      <li class="mb-4">
                          <a href="#" class="hover:underline">8 rue d'Hozier<br>13002, Marseille</a>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-black sm:text-center dark:text-black">© 2025 <a href="#" class="hover:underline text-hover-sec">Tasty™</a>. Tous droits réservés.
          </span>
